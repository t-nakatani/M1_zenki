...
//                }
            ...
            // add_event(current_time, SENDING_FIN, node_id, event.pkt, q_value_new);
            add_event(current_time, SENDING_FIN, node_id, NULL, 0);
        }
...
#endif
    // double get_min_q_value(const NeighborTable *_neoghbor_table) {
    //     decide_next_node(Packet *_pkt, int _node_id)
    // }
